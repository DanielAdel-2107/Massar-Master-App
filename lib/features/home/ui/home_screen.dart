...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    SystemChrome.setSystemUIOverlayStyle(const SystemUiOverlayStyle(
      ...
      statusBarIconBrightness: Brightness.light, // Optional: set status bar icons color
    ));
  }
  ...
  Widget _buildDrawerItem(BuildContext context, {required IconData icon, required String title, required Widget route}) {
    return ListTile(
      leading: Icon(icon),
      title: Text(title),
      onTap: () {
